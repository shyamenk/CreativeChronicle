  ...
  return (
    <div className="flex items-center justify-between py-8 text-gray-600 dark:text-gray-400">
      {prevPage ? (
        ...
        <span className="cursor-not-allowed text-gray-500 dark:text-gray-600">Previous</span>
      )}
      <span>
      ...
      {nextPage ? (
        ...
        <span className="cursor-not-allowed text-gray-500 dark:text-gray-600">Next</span>
      )}
    </div>
  )
}
      ...
      <header className="mb-16">
        <div className="relative">
          <input
            ...
            className="w-full rounded-md border-2 border-indigo-500 bg-white px-4 py-2 pr-10 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:border-indigo-400 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-400 dark:focus:ring-indigo-400 transition-all duration-200 ease-in-out"
            value={searchValue}
