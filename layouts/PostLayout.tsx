    ...
    <SectionContainer>
      ...
      <article>
        <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700">
          ...
          <div className=" mx-auto max-w-4xl grid-rows-[auto_1fr]  divide-y divide-gray-200 pb-8 dark:divide-gray-700 md:gap-x-10 xl:grid xl:grid-cols-4 xl:gap-x-6 xl:divide-y-0">
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-700 xl:col-span-3 xl:row-span-2 xl:pb-0">
              <div className="prose max-w-none pb-8 pt-10 text-md dark:prose-invert">
                {children}
              </div>
